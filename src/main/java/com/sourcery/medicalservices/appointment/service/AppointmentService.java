package com.sourcery.medicalservices.appointment.service;

import com.sourcery.medicalservices.appointment.mapper.AppointmentMapper;
...
import com.sourcery.medicalservices.appointment.model.AppointmentRequest;
import com.sourcery.medicalservices.appointment.repository.AppointmentRepository;
import com.sourcery.medicalservices.procedure.model.Procedure;
import com.sourcery.medicalservices.procedure.repository.ProcedureRepository;
...
import com.sourcery.medicalservices.user.repository.UserRepository;
...
public class AppointmentService {
  ...
  public Appointment patchAppointmentById(Long appointmentId, AppointmentRequest patchAppointment) {
    ...
    if (patchAppointment.getProcedures() != null) {
      updateAppointment.setProcedures(null);
      patchAppointment.getProcedures().forEach(procedure ->
        addProceduresToAppointment(updateAppointment.getId(), procedure.getId()));
    }
